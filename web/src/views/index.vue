<template>
  <div class="min-h-screen bg-gray-50 dark:text-slate-400 dark:bg-slate-900">
    <Header />
    <div class="mt-5 px-4 mx-auto pb-22 md:px-8 xl:px-12">
      ...
      <div class="grid gap-5 md:gap-10 grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
        <div class="relative drop-shadow-xl min-h-xs bg-white flex items-center flex-col justify-between w-full p-4 rounded-2 mb-2 md:mb-10 dark:bg-black" v-for="(item, i) in data" :key="i">
          ...
          <div class="flex flex-col items-center justify-center">
            ...
            <a-tooltip class="hidden lg:block" content="等级">
              <div class="flex items-center mb-4 text-slate-400 cursor-pointer hover:text-slate-500 dark:hover:text-slate-300" @click="toggleTheme()">
                <SvgIcon name="svg-level" size="small" />
                <div class="text-base text font-bold text-[#999]">{{ item.level }}</div>
              </div>
            </a-tooltip>
          </div>
          ...
          <div class="grid grid-cols-4 w-full">
            ...
            <a-tooltip class="hidden lg:block" content="上传">
              <div class="flex items-center ml-3 mb-2 text-slate-400 cursor-pointer hover:text-slate-500 dark:hover:text-slate-300" @click="toggleTheme()">
